...
@section('contents')
    <h1 class="font-weight-bold mb-0" style="color: rgb(1, 1, 1);">TYPES</h1>
    <style>
        .opacity-div {
    ...
    @endif
    <a href="{{ route('admin.create',['var'=>'type']) }}" class="btn bg-gradient-primary text-light">Ajoute Type</a><br>
<br>
    <div class="table-container" id="table-container">
        <table class="table table-hover opacity-div" id="exportTable">
            <thead class="opacity table-primary text-light">
                <tr>
                    <th class="align-middle text-center">Types</th>
                        ...
                        <tr class="scrolling-wrapper text-light" >
                            ...
                            <td class="align-middle text-center">
                                 {{-- <div class="btn-group" role="group" aria-label="Basic example"> --}}
                                    <a href="{{ route('admin.edit', ['var' => 'type', 'id' => $cr->idtype]) }}" type="button" class="btn btn-warning">Modifier</a>
                                    <form action="{{ route('admin.destroy', ['var' => 'type', 'id' => $cr->idtype,'nam'=>$cr->type]) }}" method="POST" class="btn btn-danger p-0" onsubmit="return confirm('Delete?')">
                                        @csrf
                                        @method('DELETE')
